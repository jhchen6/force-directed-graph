...
function addToSVG() {
    ...
    // $("#svg").append('<g class="links"></g>', '<g class="nodes"></g>');

    // links.forEach(function (link, index) {
    //     var node1 = link.source;
    //     var node2 = link.target;
    //     var linkElement = document.createElementNS(SVGNS, "link");
    //     $(linkElement).attr({
    ...
    // nodes.forEach(function (node, index) {
    //     var nodeElement = document.createElementNS(SVGNS, "circle");
    //     $(nodeElement)
    //         .attr({
    //             r: 5,
